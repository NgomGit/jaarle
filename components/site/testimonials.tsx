...
const people = [
  ...
  { initial: "F", name: "Fatou Sow", role: "Cosmétiques, Touba", fr: "J'envoie juste la photo et le prix par la voix, Affisse fait le reste. Mes publications ont plus de réactions qu'avant.", en: "I just send the photo and price by voice, Affisse does the rest. My posts get more reactions than before." },
];
